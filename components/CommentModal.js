        ...
        <div className="p-1">
            <div className="border-b border-gray-200 py-2 px-1.5">
                <div className="hoverEffect w-10 h-10 flex items-center justify-center">
                    <XIcon onClick={() => setOpen(false)} className="h-[23px] p-0 text-gray-700"/>
                </div>
            </div>
            ...
            <div className="w-full divide-y divide-gray-200">  
                ...
                <div className="flex items-center justify-between pt-2.5">
                     ...
                     <button onClick={sendComment} disabled={!input.trim()} className="bg-blue-400 text-white px-4 py-1.5 rounded-full font-bold shadow-md hover:brightness-95 disabled:opacity-50">
                        Tweet
                    </button>

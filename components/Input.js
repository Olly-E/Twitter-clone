...
export default function Input() {
  return (
    <div className="flex border-b border-gray-200 p-3 space-x-3">
        <img  className="h-11 w-11 rounded-full cursor-pointer hover:brightness-95" src="https://nuelportfolio.netlify.app/static/media/me-about.5cea161175f687029ed3.png" alt="user-image" />
